...
public class MinLengthValidatorTest {
    ...
    public void isValidTest() {
        ...
        Throwable exception = Assertions.assertThrows(IllegalArgumentException.class, () -> minLengthValidator.isValid(""));
        Assertions.assertEquals("Password cannot be null or blank", exception.getMessage());

        Assertions.assertTrue(minLengthValidator.isValid("Pa"), "Password should contain 2 or more characters");
        Assertions.assertFalse(minLengthValidator.isValid("F"), "Password should contain 2 or more characters");
