...
public class SpecialCharacterLengthValidatorTests {
    ...
    public void isValidTest() {
        ...
        Throwable exception = Assertions.assertThrows(IllegalArgumentException.class, () -> specialCharacterLengthValidator.isValid(""));
        Assertions.assertEquals("Password cannot be null or blank", exception.getMessage());

        Assertions.assertTrue(specialCharacterLengthValidator.isValid("@password#"), "Password should contain 2 or more special characters");
        Assertions.assertFalse(specialCharacterLengthValidator.isValid("password"), "Password should contain 2 or more special characters");
        Assertions.assertFalse(specialCharacterLengthValidator.isValid("@password"), "Password should contain 2 or more special characters");
