...
public class SurveyResponseServiceTest {
    ...
    public void saveSurveyResponseTest() throws Exception {
        ...
        Optional<SurveyQuestionResponseDTO> optionalSurveyQuestionResponseDTO = Optional.of(surveyQuestionResponseDTO);
        Optional<SurveyQuestionResponseDTO> responseDTO;

        Mockito.when(surveyResponseService.saveSurveyResponse(surveyQuestionResponseDTO)).thenReturn(optionalSurveyQuestionResponseDTO);
        ...
        Assert.notEmpty(responseDTO.get().getResponse(), "survey question response list should not empty");
