...
public class ConnectionManager {
  ...
  public Optional<Connection> getDBConnection() throws SQLException, ClassNotFoundException {
    ...
    try {
      ...
      connection = Optional.of(DriverManager.getConnection(databaseUrl, dbUserName, dbPassword));
